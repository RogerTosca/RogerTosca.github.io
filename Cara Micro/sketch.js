...
function draw() {
  ...
  ellipse(300,200,200+h,225+h);//Forma de la cara exterior
...
ellipse(250,170,35,35);//Forma de l'ull dret perquè x=250
ellipse(350,170,35,35);//Forma de l'ull esquerra perquè x=350
  line(320, 140, 370, 130);
  line(220, 135, 270, 140);
  fill(255-h*5,0,0)
  arc(300, 250, 70, 70+h,0,PI);//Forma de la boca
}
